				...
				<div class="card card-sidebar-mobile">
					...
					<li class="nav-item nav-item-submenu">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								<li class="nav-item"><a href="datatable_basic.php" class="nav-link active">Basic initialization</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">AGREGAR</span> - DEPARTAMENTO</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_basic.php" class="breadcrumb-item">DEPARTAMENTOS</a>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							...
							<tr>
								...
								<td>11</td>
								<td><span class="badge badge-info">SUSPENDIDA</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
