			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Pagina principal</h4>
					...
					<div class="col-xl-8">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">MARKETING DE LAS EMPRESAS</h6>
								<div class="header-elements">
									<span class="badge bg-success badge-pill">5 Activas</span>
							...
							<div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
								<div class="d-flex align-items-center mb-3 mb-sm-0">
									<div id="campaigns-donut">AEROPOSTALE</div>
									<div class="ml-3">
								...
								<div class="d-flex align-items-center mb-3 mb-sm-0">
									<div id="campaign-status-pie">GOLONDRINAS</div>
									<div class="ml-3">
								...
								<div class="card bg-teal-400">
									<div class="card-body">
										<div class="d-flex">
											...
											<span class="badge bg-teal-800 badge-pill align-self-center ml-auto">+20%</span>
					                	</div>
					                	
					                	<div>
											HOME DEEPOT
											<div class="font-size-sm opacity-75">5 personas</div>
										</div>
									</div>
...
<!--
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">HORARIO DE LA EMPRESA</h6>
								<div class="header-elements">
...
-->
								<div class="d-flex align-items-center mb-3 mb-md-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">MOVISTAR</h5>
								...
								<div class="d-flex align-items-center mb-3 mb-md-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">06:30:00</h5>
										<span class="text-muted">RESPONDE CADA 2 HORAS</span>
									</div>
								</div>
								...
								<table class="table text-nowrap">
									...
									<tbody>
										...
										<tr>
											<td class="text-center">
												<h6 class="mb-0">12</h6>
												<div class="font-size-sm text-muted line-height-1">HORAS</div>
											</td>
											<td>
												<div class="d-flex align-items-center">
													<div class="mr-3">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title">NILMA</a>
														<div class="text-muted font-size-sm"><span class="badge badge-mark border-blue mr-1"></span> ACTIVA</div>
													</div>
												</div>
											</td>
											<td>
												...
												<a href="#" class="text-default">
													<div class="font-weight-semibold">COLONIA NIÑOS HEROES<div>
													<span class="text-muted"></span>
												</a>
											</td>
...
<!--
										...
										<tr>
											...
											<td>
												<a href="#" class="text-default">
													<div>[#1046] Avoid some unnecessary php string</div>
													<span class="text-muted">Rather than building a string of php and then parsing it...</span>
												</a>
											</td>
											<td class="text-center">
												<div class="list-icons">
					...
					-->
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								...
								<div class="header-elements">
									<span><i class="icon-history text-warning mr-2"></i> Oct 21, 10:30</span>
									<span class="badge bg-success align-self-start ml-3">ACTIVOS</span>
								</div>
							</div>
									...
									<ul class="media-list">
										<li class="media">
											...
											<div class="media-body">
												<div class="d-flex justify-content-between">
													<a>MOVISTAR</a>
													<span class="font-size-sm text-white">10:00am</span>
												</div>
										...
										<li class="media">
											...
											<div class="media-body">
												<div class="d-flex justify-content-between">
													<a>NILMA</a>
													<span class="font-size-sm text-white">12:16</span>
												</div>
										...
										<li class="media">
											...
											<div class="media-body">
												<div class="d-flex justify-content-between">
													<a>GOLONDRINAS</a>
													<span class="font-size-sm text-white">09:00</span>
												</div>
											</div>
										</li>
									</div>
...
<!--
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">SALARIOS</h6>
								<div class="header-elements">
									...
									<span class="badge bg-danger-400 badge-pill">+8</span>
								</div>
							</div>
							...
							<div class="card-body">
								...
								<ul class="media-list">
									<li class="media">
										...
										<div class="media-body">
										 <span class="font-weight-semibold">HOMEDEEPOT</span><span class="font-weight-semibold text-danger">$4220</span> MENSUALES
									...
									<li class="media">
										...
										<div class="media-body">
											<span class="font-weight-semibold">
											 AEROPOSTALE</a><a href="#">$10000</a> MENSUALES
											<div class="text-muted"></div>
										</div>
