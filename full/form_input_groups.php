					...
					-->
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item"><a href="form_input_groups.php" class="nav-link active">Input groups</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">AGREGAR</span>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_input_groups.php" class="breadcrumb-item">Agregar</a>
			...
			-->
				...
				<div class="row">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input type="text"class="temas a tratar">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">DATOS INSTITUCIONALES DEL ALUMNO</h5>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
