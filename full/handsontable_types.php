					...
					-->
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Handsontable">
								...
								<li class="nav-item"><a href="handsontable_types.php" class="nav-link active">Basic cell types</a></li>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">LISTADO DE LAS TUTORIAS</span> 
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="handsontable_types.php" class="breadcrumb-item">Listado</a>
						</div>
			...
			<div class="content">
				<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							...
							<div class="text-center">
								...
								<div class="btn-group">
			                    	<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left dropdown-toggle" data-toggle="dropdown"><b><i class="icon-add"></i></b>Registrar Tutoria</button>
			                    	<div class="dropdown-menu dropdown-menu-right">
										<a href="fullcalendar_advanced.php" class="dropdown-item"><i class="icon-calendar"></i> Agendar</a>
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-3">Verificar que este su tutoria agendada
