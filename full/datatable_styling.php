				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_styling.php" class="breadcrumb-item">DEPARTAMENTOS</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<form action="#">
							...
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">SEGURO</legend>
<!--
								<div class="form-group row">
									<label class="col-form-label col-lg-2">NOMBRE DEL HOSPITAL AFILIADO</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text">🏪<class="icon-user"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="NOMBRE">
										</div>
									</div>
...
-->
								<div class="form-group row">
									<label class="col-form-label col-lg-2">N° DE SEGURO</label>
									<div class="col-lg-10">
										<div class="input-group">
											</span>
											<input type="text" class="form-control" placeholder="ejemplo: 1459">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">TIPO DE SANGRE</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text">🩸<class="icon-user"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="ejemplo +O">
											<span class="input-group-append">
												</div>
									</div>
								</div>
			...
			-->
				...
				<div class="card">
					...
					<div class="card-body">
						The <code>DataTables</code> is a highly flexible tool, based upon the foundations of progressive enhancement, and will add advanced interaction controls to any php table. DataTables has most features enabled by default, so all you need to do to use it with your own tables is to call the construction function. Searching, ordering, paging etc goodness will be immediately added to the table, as shown in this example. <strong>Datatables support all available table styling.</strong>
					</div>
