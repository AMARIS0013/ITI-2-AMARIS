							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables extensions">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="datatable_extension_buttons_flash.php" class="nav-link active">Flash buttons</a></li>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">SOLICITAR VACACIONES</span>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_extension_buttons_flash.php" class="breadcrumb-item">SOLICITAR</a>
							<span class="breadcrumb-item active">SOLICITAR VACACIONES</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						Solo tiene que llenar y enviar sus datos correspondientes
					</div>
					</div>
...
-->
							...
							-->
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">FECHA DE REGRESO</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="FECHA DE REGRESO">
										</div>
									</div>
								</div>
			...
			-->
				...
				<div class="card">
					...
					<div class="card-body">
						It can often be useful to include description text in the print view to provide summary information about the table that will be included in the generated PDF. The <code>message</code> option of the <code>pdfFlash</code> button type provides this ability. It is a simple string and cannot contain any formatting information. If you require control over the styling of the exported PDF, please refer to the <code>pdfphp5</code> button type.
					</div>
