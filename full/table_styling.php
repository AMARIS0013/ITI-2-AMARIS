					...
					-->
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								...
								<li class="nav-item"><a href="table_styling.php" class="nav-link active">Table styling</a></li>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">EDITAR LAS VACACIONES</span>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_styling.php" class="breadcrumb-item">EDITAR LAS VACACIONES
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">EDITA TUS VACACIONES</h5>
					...
					<div class="card-body">
						Edita o elimina tus vacaciones
					</div>
					...
					<table class="table datatable-responsive">
						...
						<tbody>
							<tr>
								<tr>
								<td><button type=" button" class="btn btn-danger" data-toggle="modal" data-target="#modal_default">🗑<i class=></i><button type=" button" class="btn btn-info" data-toggle="modal" data-target="#modal_default">📝</td>
								<td>VERONICA</td>
								<td>RUIZ</td>
			...
			-->
				...
				<div class="card">
					...
					<div class="card-body">
						Example of a custom table <code>header</code> styling. Table header supports default contextual and custom background colors available in <a href="colors_primary.php">custom color system</a>. To use custom color in the table header, add <code>.bg-*</code> class to the header row. All border and text colors will be automatically adjusted.
					</div>
			...
			-->
				...
				<div class="card">
					...
					<div class="card-body">
						Example of a custom table <code>footer</code> styling. Table footer supports custom background colors available in <a href="colors_primary.php">custom color system</a>. To use custom color in the table footer, add <code>.bg-*</code> class to the footer row. All border and text colors will be autocatically adjusted.
					</div>
			...
			-->
				...
				<div class="card">
					...
					<div class="card-body">
						Example of <code>custom colors</code> for table rows. Add one of the custom colors from the template color system to any table row for additional highlighting. Unlike contextual classes, these colors are much stronger. View all <a href="colors_primary.php">available colors here &rarr;</a>.
					</div>
			...
			-->
				...
				<div class="card">
					...
					<div class="card-body">
						Example of a table with custom <code>background</code> color. Any table could have different background colors available in <a href="colors_primary.php">custom color system</a>. To use one of these colors add <code>.bg-*</code> color class to the table with <code>.table</code> class.
					</div>
