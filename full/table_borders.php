			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">EDITAR EMPLEADOS</span> 
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_borders.php" class="breadcrumb-item">EDITAR EMPLEADOS</a>
							</div>
							</div>
						</div>
					</div>
	 ...
	 <!-- Input group addons -->
		<div class="card">
				<div class="card-header header-elements-inline">
					...
					<div class="card-body">
						<p class="mb-4">Llenar los datos correspondientes
