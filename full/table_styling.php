				...
				<div class="card card-sidebar-mobile">
					...
					<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								...
								<li class="nav-item"><a href="datatable_extension_buttons_flash.phpl" class="nav-link">Solicitar</a></li>
					...
					-->
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								...
								<li class="nav-item"><a href="table_styling.html" class="nav-link active">Table styling</a></li>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_styling.html" class="breadcrumb-item">EDITAR LAS VACACIONES
